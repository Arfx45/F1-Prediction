...
for _, race in races_2024.iterrows():
    ...
    win_probs = model.predict(race_scaled).flatten()
...
predictions_df.to_csv('data/2024/predicted_results2024RNN.csv', index=False)
...
print("\nSaved predictions to 'data/2024/predicted_results2024RNN.csv'")
